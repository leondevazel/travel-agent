...
BALANCED_DAYS = [ItineraryDay(day_number=1, date="2026-11-01", locations=["Louvre"], activities=["Louvre", "Musee d'Orsay"], notes="")]
RELAXED_DAYS = [ItineraryDay(day_number=1, date="2026-11-01", locations=["Louvre"], activities=["Louvre"], notes="relaxed pace")]
