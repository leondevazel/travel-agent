...
async def test_itinerary_agent_composes_days_from_context_in_one_turn():
    ...
    response = FakeResponse(
        content=[
            ...
            FakeBlock(
                ...
                input={
                    "days": [
                        {"day_number": 1, "date": "2026-11-01", "locations": ["Louvre"], "activities": ["Louvre"], "notes": "relaxed pace"},
                    ]
                },
            ),
        ],
    ...
    assert days == [ItineraryDay(day_number=1, date="2026-11-01", locations=["Louvre"], activities=["Louvre"], notes="relaxed pace")]
